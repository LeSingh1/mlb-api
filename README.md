...
![CI](https://github.com/LeSingh1/mlb-api/actions/workflows/test.yml/badge.svg) ![license](https://img.shields.io/badge/license-MIT-blue.svg) ![node](https://img.shields.io/badge/node-%E2%89%A518-brightgreen.svg) ![dependencies](https://img.shields.io/badge/dependencies-0-success.svg)

Unofficial Node client for ESPN's MLB data. ESPN serves MLB under
`baseball/mlb`, and this wraps those endpoints with retry/timeout
transport and parsers that return clean data.

Part of the [espn-api](https://github.com/LeSingh1/espn-api) family. The parent
is one client for every sport. This one is just MLB, in the style of
swar/nba_api.
...
```
git clone https://github.com/LeSingh1/mlb-api
cd mlb-api
node examples/scoreboard.js   # MLB games
...
A scheduled GitHub Action runs once a day, pulls that day's MLB games from
