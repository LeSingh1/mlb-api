...
Small, unofficial Node client for ESPN's MLB data. ESPN serves MLB
under `baseball/mlb`, and this wraps those endpoints.

Part of the [espn-api](https://github.com/LeSingh1/espn-api) family. The parent
repo is one client for every sport. This one is just MLB, in the style of
...
cd mlb-api
node examples/scoreboard.js   # MLB games on the board
